...
def create_eva_vit_5b(img_size=224,drop_path_rate=0.4,use_checkpoint=False,precision="fp16"):
    ...
    cached_file = '/mnt/petrelfs/share_data/caoyuhang/models/EVA02_CLIP_E_psz14_plus_s9B_visual.pt'
    ...
    if precision == "fp16":
        print('convert ViT weights to fp16')
