...
def replace_llama_attn_with_flash_attn():
    ...
    vigc.models.blip2_models.modeling_llama.LlamaModel._prepare_decoder_attention_mask = (
        _prepare_decoder_attention_mask
    )
    vigc.models.blip2_models.modeling_llama.LlamaAttention.forward = forward
